  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white p-10">
      ...
      <form onSubmit={handleSubmit} className="max-w-3xl space-y-6">
        ...
        <input
          name="capital_requerido"
          type="number"
          value={form.capital_requerido}
          onChange={handleChange}
          placeholder="Capital requerido"
          className="w-full p-4 rounded-xl bg-slate-900"
          required
        />
        ...
        <input
          name="retorno_ofrecido"
          value={form.retorno_ofrecido}
          onChange={handleChange}
          placeholder="Retorno ofrecido, ejemplo: 15% en 6 meses"
          className="w-full p-4 rounded-xl bg-slate-900"
        />
